...
SECRET_VARS="AGENTROUTER_API_KEY CLOUDFLARE_ACCOUNT_ID CLOUDFLARE_API_TOKEN CLOUDFLARE_BASE_URL CLOUDFLARE_MODEL CLOUDFLARE_MODELS COHERE_API_KEY FOUNDRY_API_KEY GEMINI_API_KEY GEMINI_API_KEY_BACKUP HF_TOKEN MISTRAL_API_KEY NOVA_ANALYZE_MAX_CHARS NOVA_API_KEY NOVA_BASE_URL NOVA_MAX_UPLOAD_MB NOVA_MODEL NOVA_SANDBOX OLLAMA_API_KEY OLLAMA_BASE_URL OLLAMA_MODEL OPENROUTER_API_KEY OPENROUTER_BASE_URL OPENROUTER_MODELS REQUESTY_API_KEY REQUESTY_BASE_URL REQUESTY_MODELS"
